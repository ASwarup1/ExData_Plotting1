...
par(mfrow = c(2,2))
#
plot(Global_active_power ~ datetime, data=plotData, type = "l", ylab="Global Active Power",xlab="")
mtext("Plot 4", side=3, line=1, adj=0, cex=1, font=2)
#
